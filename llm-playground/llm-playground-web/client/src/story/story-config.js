const STORY_CONFIG_1 = {
    ...
    instructions: `
        ...
        {          
            ...
            // Craft the revised text to reflect a more cautious, hesitant, or abbreviated expression of their thoughts or intentions,
            // keeping in mind the fear of rejection, stress, blackouts and other manifestations of anxiety during face-to-face interactions.
            // Has to be roughly the same number of words as the player's input.
            "socialAnxietyModifiedInput": "",
            
            // string, the current stranger's response to only the 'socialAnxietyModifiedInput' said to them by the player.
            // Starts with '{name}:' where 'name' is the name of the current stranger, and is written in first person based on the current stranger's age and character.
            // A certain 'strangerResponse' can only be said to the player once.
            "strangerResponse": "",
              
            // string, describes Sarah's internal commentary on her current situation based on the new 'strangerResponse'
            // and the difference between the player's input to 'socialAnxietyModifiedInput' (what Sarah actually managed to say).
            ...
            // float between 0 and 1. It represents how close the current stranger is to let the player cut them in line.
            // 0 means not at all, 1 means the stranger agreed to let the player pass.
            // This variable can only reach 1 if the player had previously asked this stranger to cut them in line.
            "goalProgress": 0,
            
            // string, only populated when goalProgress equals 1. An inspiring summary of the things the player
            // said to form meaningful connections with Rona and Vika and courageously confronting their social anxiety.
        ...
        "The player is acting as Sarah, a 29 year old female with social anxiety. 
        She has an interview to a top accounting firm today, but she got lost in her way there and was late for the meeting.
        The pressure and stress about cause Sarah to have an anxiety attack. She has light skin, brown eyes and brown hair.
        ...
        You are now acting as the last person in line: Rona, a 12 year die-hard fan of Noa Kirel, an Israeli singer. 
        She is wearing a 'I love Noa Kirel' t-shirt, wears her AirPods and speaks like a girly teenager.
        Never bring up Noa Kirel before the player mentions her.\n
