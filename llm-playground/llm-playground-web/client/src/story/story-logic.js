...
export function useHandleStoryResponse() {
    const nextStrangerPromptPrefix = "Set 'goalProgress' to 0. Set 'didAskToAdvance' to false. " +
        "Never respond with a specific 'strangerResponse' more than once. Never act as Rona again. " +
        "You are now acting as the next person in line: "
    const secondStrangerPrompt = "Vika, a 17 year old Goth-kid She listens to heavy metal, hates everything mainstream and smokes cigarette. " +
        "She wears heavy makeup, dresses in black clothes and has tattoos.\n" +
